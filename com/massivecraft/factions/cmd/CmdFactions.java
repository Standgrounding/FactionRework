  ...
  extends FactionsCommand
{
  ...
  public CmdFactionsXPlaceholder cmdFactionsTax = new CmdFactionsXPlaceholder("FactionsTax", new String[] { "tax" });
  public CmdFactionsXPlaceholder cmdFactionsDynmap = new CmdFactionsXPlaceholder("FactionsDynmap", new String[] { "dynmap" });
  ...
  public MassiveCommandVersion cmdFactionsVersion = (MassiveCommandVersion)new MassiveCommandVersion(Factions.get()).setAliases(new String[] { "v", "version" }).addRequirements(new Requirement[] { RequirementHasPerm.get(Perm.VERSION) });
  ...
  public CmdFactions()
  {
    ...
    addChild(new MassiveCommandDeprecated(cmdFactionsFaction, new String[] { "show", "who" }));
  }
